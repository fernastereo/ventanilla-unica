<script setup>
  ...
  const navigation = [
    ...
    { name: 'Nueva Solicitud', to: '/peticion', icon: FolderIcon, current: false },
    { name: 'Mis Solicitudes', to: '/listadopeticiones', icon: DocumentDuplicateIcon, current: false },
  ]
                    ...
                    <li>
                      <ul role="list" class="-mx-2 space-y-1">
                        <li v-for="item in navigation" :key="item.name">
                          <RouterLink :to="item.to" :class="[item.current ? 'bg-gray-800 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white', 'group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6']">
